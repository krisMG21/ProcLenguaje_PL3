...
public class MiniBParser extends Parser {
	...
	public static final int
		...
		DIM=27, REDIM=28, LT=29, GT=30, LE=31, GE=32, EQ=33, PLUS=34, MINUS=35, 
		MUL=36, DIV=37, ID=38, NUMBER=39, STRING_LITERAL=40, NEWLINE=41, COMMENT=42, 
		WS=43;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"EXIT", "END", "THEN", "MOD", "VAL", "LEN", "ISNAN", "DIM", "REDIM", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 275282341632L) != 0)) {
				{
				setState(49);
				statement();
				}
	...
	public final IfStmtContext ifStmt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 275282341632L) != 0)) {
				{
				{
				setState(89);
